...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScrollSync = function (_Component) {
	  ...
	  function ScrollSync(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, (ScrollSync.__proto__ || Object.getPrototypeOf(ScrollSync)).call(this, props));
	  ...
	  _createClass(ScrollSync, [{
	    ...
	    value: function syncScrollPosition(scrolledPane, pane) {
	      ...
	      if (vertical && scrollTopOffset > 0) {
	        ...
	        else pane.scrollTop = proportional ? paneHeight * scrollTop / scrollTopOffset : scrollTop; // eslint-disable-line
	      }
	      if (horizontal && scrollLeftOffset > 0) {
	        if (!this.state.initialized) pane.scrollLeft = initialScrollLeft;
	        // eslint-disable-next-line curly
	        else pane.scrollLeft = proportional ? paneWidth * scrollLeft / scrollLeftOffset : scrollLeft; // eslint-disable-line
	      }
	...
	ScrollSync.propTypes = {
	  ...
	  initialScrollLeft: _propTypes2.default.number,
